...
const BigActivityCards = () => {
  ...
  return (
    <Box sx={{ backgroundColor: 'common.black'}}>
        <Typography fontSize='24px' color='common.white' padding='10px 0px 0px 20px'>Things to do in your City</Typography>
        <Typography fontSize='14px' lineHeight='10px' color='common.white' paddingLeft='20px'>Discover unique experiences offered in your city</Typography>
        <Slider {...settings}>
          <Box>
            <Box sx={{ display: 'flex', paddingTop: '20px', paddingLeft: '20px' }}>
              ...
              <Box sx={{ paddingLeft: '20px', width: '55%' }}>
                <Typography fontSize='20px' color='common.white'>Amusement Park</Typography>
                <Typography fontSize='14px' color='common.white'>Location</Typography>
                <Typography fontSize={isMobile ? "12px" : "16px"} color='common.white' paddingTop='10px' style={{ width: '100%', whiteSpace: 'normal', wordWrap: 'break-word' }}>
                ...
                <Typography fontSize='20px' paddingTop='10px' color='common.white'>Aed 799</Typography>
              </Box>
            </Box>
          ...
          <Box>
            <Box sx={{ display: 'flex', paddingTop: '20px', paddingLeft: '20px' }}>
              ...
              <Box sx={{ paddingLeft: '20px', width: '55%' }}>
                <Typography fontSize='20px' color='common.white'>Spa</Typography>
                <Typography fontSize='14px' color='common.white'>Location</Typography>
                <Typography fontSize={isMobile ? "12px" : "16px"} color='common.white' paddingTop='10px' style={{ width: '100%', whiteSpace: 'normal', wordWrap: 'break-word' }}>
          ...
          <Box>
            <Box sx={{ display: 'flex', paddingTop: '20px', paddingLeft: '20px' }}>
              ...
              <Box sx={{ paddingLeft: '20px', width: '55%' }}>
                <Typography fontSize='20px' color='common.white'>Jet Ski</Typography>
                <Typography fontSize='14px' color='common.white'>Location</Typography>
                <Typography fontSize={isMobile ? "12px" : "16px"} color='common.white' paddingTop='10px' style={{ width: '100%', whiteSpace: 'normal', wordWrap: 'break-word' }}>
          ...
          <Box>
            <Box sx={{ display: 'flex', paddingTop: '20px', paddingLeft: '20px' }}>
              ...
              <Box sx={{ paddingLeft: '20px', width: '55%' }}>
                <Typography fontSize='20px' color='common.white'>Jungle Safari</Typography>
                <Typography fontSize='14px' color='common.white'>Location</Typography>
                <Typography fontSize={isMobile ? "12px" : "16px"} color='common.white' paddingTop='10px' style={{ width: '100%', whiteSpace: 'normal', wordWrap: 'break-word' }}>
